...
@patch("tg_cli.session.keyring")
class TestSession:
    def test_save_session(self, mock_kr):
        save_session("abc123")

        mock_kr.set_password.assert_called_once_with(
            "tg-cli", "telegram_session", "abc123"
        )
    ...
    def test_load_session_exists(self, mock_kr):
        ...
        mock_kr.get_password.assert_called_once_with("tg-cli", "telegram_session")
    ...
    def test_delete_session(self, mock_kr):
        ...
        mock_kr.delete_password.assert_called_once_with("tg-cli", "telegram_session")
